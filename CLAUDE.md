...
- **Headers**:
  ...
  - `rogue.h`: game constants, structs, prototypes, and the intrusive list templates. It includes `entities/Creature.hpp` and `entities/Item.hpp` (the split of the old `union thing`), then `game/Game.hpp`.
